...
class Settings:
    ...
    def from_env(cls, env_file: str | Path | None = None) -> "Settings":
        ...
        return cls(
            ...
            openrouter_model=os.getenv("NVIDIA_MODEL") or os.getenv("OPENROUTER_MODEL", "nvidia/nemotron-3-super-120b-a12b"),
            llm_base_url=os.getenv("LLM_BASE_URL", "https://integrate.api.nvidia.com/v1"),
            gcp_project_id=os.getenv("GCP_PROJECT_ID", "nexuslatam-master"),
            bigquery_dataset=os.getenv("BIGQUERY_DATASET", "NEXUS_GROUPM_BI_2"),
            bigquery_bicomp_table=os.getenv("BIGQUERY_BICOMP_TABLE", "tb_data_bicompetitive"),
    ...
    def validate_bigquery(self) -> None:
        ...
        if missing:
            raise ValueError("Configuración BigQuery incompleta: " + ", ".join(missing))
